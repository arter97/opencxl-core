...
class DownstreamPortDevice(CxlPortDevice):
    ...
    async def _run(self):
        ...
        run_tasks = [create_task(self._cxl_io_manager[i].run()) for i in range(self._num_vppb)] + [
    ...
    async def _stop(self):
        ...
        tasks = [create_task(self._cxl_io_manager[i].stop()) for i in range(self._num_vppb)] + [
